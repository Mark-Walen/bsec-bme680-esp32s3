...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partition_table/partitionTable.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partition_table/partitionTable.csv"
